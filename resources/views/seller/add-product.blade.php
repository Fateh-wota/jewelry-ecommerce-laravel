...
<head>
    ...
    <style>
        *, ::after, ::before { box-sizing: border-box !important; }
        ...
        .sidebar { min-height: 100vh !important; background: #2d3436 !important; width: 260px !important; position: fixed !important; color: white !important; z-index: 1000 !important; }
        ...
        .sidebar .nav-link:hover, .sidebar .nav-link.active { background: #d63384 !important; color: white !important; }
        ...
        .form-label { font-weight: 500 !important; color: #2d3436 !important; }
        .form-control:focus, .form-select:focus { border-color: #d63384 !important; box-shadow: 0 0 0 0.25rem rgba(214, 51, 132, 0.1) !important; }
    </style>
</head>
    ...
    <div class="d-flex">
        <div class="sidebar shadow">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link active" href="{{ route('seller.product.create') }}"><i class="fas fa-plus-circle me-2"></i> Tambah Produk</a>
                <hr class="mx-3" style="opacity: 0.1">
                <a href="{{ route('seller.dashboard') }}" class="nav-link text-warning"><i class="fas fa-arrow-left me-2"></i> Kembali</a>
            </nav>
        </div>
            ...
            <div class="card-custom">
                <form action="{{ route('seller.product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Contoh: Cincin Berlian 24K" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" class="form-control" rows="4" placeholder="Ceritakan detail keindahan produk ini..."></textarea>
                    </div>
