...
<body>
    ...
    <header class="hero-section" id="home">
        <div class="hero-text">
            ...
            <p class="text-muted fs-5 mt-3">Explore our exquisite collection of fine jewelry, crafted with precision and
                passion.</p>
            <div class="mt-4">
                <a href="#koleksi" class="btn btn-danger px-4 py-2"
                    style="background-color: var(--magenta-primary); border: none; border-radius: 8px;">Shop Now</a>
                <button class="btn btn-outline-secondary px-4 py-2 ms-2"
                    style="border-radius: 8px;">Collections</button>
            </div>
        </div>
                    ...
                    <div class="card product-card">
                        ...
                        <div class="card-body p-4">
                            <small class="text-muted uppercase fw-bold"
                                style="font-size: 10px;">{{ $product->user->name ?? 'Jewelry Shop' }}</small>
                            <h5 class="fw-bold mb-2">{{ $product->name }}</h5>
                            <h5 class="text-magenta fw-bold mb-3">Rp {{ number_format($product->price, 0, ',', '.') }}</h5>

                            <div class="d-grid">
                                <a href="{{ route('product.detail', $product->id) }}" class="btn btn-magenta">
